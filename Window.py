...
class Window(Tk):
    ...
    def __init__(self):
        ...
        self.list.grid(row = 2,column=0,columnspan=2,sticky="WE")
        self.scroll_y.grid(row = 2,column=1,sticky="ESN")
        self.scroll_x.grid(row = 3,column=0,sticky="WE")
        self.f1.grid(row=2,column=2,columnspan = 2,sticky = "SNWE",padx="10")
        ...
        self.rbut_name.grid(row=0,column=1,sticky=E)
